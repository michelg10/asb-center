      ...
      onLoad: async function(){
        ...
        eventChannel.on('userData', async (res) => {
          ...
          if(checkHouse.data.length===0){
            ...
            if(checkHouse.data[0].dinnerOption===undefined){
              this.setData({
                mealSelection: "Not Selected",
                mealSelectionClass: "no"
              });
              ...
              this.setData({
                mealSelection: checkHouse.data[0].dinnerOption,
                mealSelectionClass: "yes"
              });
              if (checkHouse.data[0].dinnerOption === "Fish"){
                this.setData({
                  cheese: false,
                  fish: true,
                });
              }
              else if(checkHouse.data[0].dinnerOption === "Cheese"){
                this.setData({
                  cheese: true,
                  fish: false,
                });
            ...
            if(checkHouse.data.length !== 0 && checkHouse.data[0].consent === true && this.data.consent === true){
              wx.navigateBack();
            }
